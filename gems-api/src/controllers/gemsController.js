...
cloudinary.config({
    cloud_name:"dgx8920kf",
    api_key:"141956947577899",
    api_secret: "yni9MEPFlx1m_moJjlcnt9sAh50"
})
...
async function createGem(req, res){
    ...
    await newGem.save()
    res.status(201).send({_id: newGem._id , success_msg: 'New gem Created successfull'})
